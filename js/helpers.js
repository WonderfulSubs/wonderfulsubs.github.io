...
var darkThemeStyles = m('style', 'nav .brand{filter:brightness(0) invert(1)}.nav-menu,.nav-menu-content{background-color:#000}body{background-color:#393939;color:#fff}.nav-buttons a,.nav-buttons button{color:#fff}.nav-search input{background-color:rgba(255,255,255,.15);color:#fff}.nav-search i{color:#fff}.poster-header{color:#fff}.poster-item{box-shadow:none}.poster-item .poster-title{background-color:#424242;color:#fff}.poster-item .poster-language{background-color:#717171}.poster-item .poster-watch-later{background-color:#000}.poster-item .poster-watch-favorite{background-color:#151515}.bottom-bar{background-color:#000}.footer{background-color:#000}#user-panel{background-color:rgba(0,0,0,.75)}.button,.label,.select select:focus,[data-tooltip]:after,[type=checkbox]+.checkable:hover:before,[type=checkbox]:focus+.checkable:before,[type=radio]+.checkable:hover:before,[type=radio]:focus+.checkable:before,[type=submit],button,select:active,select:focus,th{background-color:#000}@media only screen and (max-width:767px){.dropdown-content a{color:#000}}');
