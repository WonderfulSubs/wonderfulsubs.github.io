...
function MediaPlayer(src, options, ready) {
    ...
    var _this = {
        ...
        view: function () {
            return m('video', { id: 'video-player', class: 'video-js vjs-big-play-centered animated fadeInDown' + (/*showTheaterToggle &&*/ (options && !options.dontDoTheater) && theaterModeEnabled ? ' theater-player' : ''), playsinline: 'playsinline' });
        }
    };
