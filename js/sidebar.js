...
var sidebarStyles = m('style', '.content-wrapper-container.flex{margin:0 auto;flex-direction:column-reverse}@media only screen and (min-width:1000px){.content-wrapper-container.flex{flex-direction:row}}');

var Sidebar = m.fragment({}, [
    m('div', { class: 'sidebar-container animated zoomIn faster' }, [
